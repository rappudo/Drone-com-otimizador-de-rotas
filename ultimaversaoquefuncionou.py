...
ponto_inicial = np.array([0, 0, 0])  # Definir o ponto inicial
pontos_recarga = {(31, 46, 53), (75, 93, 28)}  # Definir os pontos de recarga
...
melhor_rota, pontos_visitados, distancia_total = algoritmo_genetico_com_recarga_materiais(pontos, ponto_inicial, pontos_recarga, distancia_maxima, materiais_maximos, tamanho_populacao=200, n_geracoes=500, taxa_mutacao=0.05)
